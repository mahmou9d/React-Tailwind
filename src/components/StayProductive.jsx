...
// @ts-ignore
import StayProductiveImg from "/public/images/illustration-stay-productive.png";
    ...
    <section>
      <div className="container pb-[150px] grid grid-cols-1 md:grid-cols-2 gap-[30px]   place-items-center">
        ...
        <div>
          ...
          <Link
            to="/"
            className="text-primary hover:text-[#42b0d1] hover:border-[#42b0d1] transition-all duration-200  border-b-2 border-primary pb-[5px] flex items-center gap-[15px] w-fit"
          >
            See how Fylo works
            <img
              src={ArrowImg}
